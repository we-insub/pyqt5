# 라디오 버튼은 일반적으로 사용자에게 여러 개 중 하나의 옵션을
# 선택하도록 할 때 사용됩니다. 그래서 한 위젯 안에 여러
# 라디오 버튼은 기본적으로 autoExclusive로 설정되어 있습니다.
# 하나의 버튼을 선택하면 나머지 버튼들은 선택 해제가 됩니다.
# 한 번에 여러 버튼을 선택할 수 있도록 하려면
# setAutoExclusive() 메서드에 False를 입력해주면 됩니다.
# 또한 한 위젯 안에 여러 개의 exclusive 버튼 그룹을 배치하고 싶다면
# QButtonGroup() 메서드를 사용할 수 있습니다. (QButtonGroup 공식 문서 참고)
# 체크 박스와 마찬가지로 버튼의 상태가 바뀔 때,
# toggled() 시그널이 발생합니다. 또한 특정 버튼의 상태를 가져오고 싶을 때,
