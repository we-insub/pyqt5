...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        # 라벨클래스 라벨 텍스트는 각각 'Red', 'Green', 'Blue'로 설정합니다

        lbl_red.setStyleSheet("color: red;"
                             "border-style: solid;"
                             "border-width: 2px;"
                             "border-color: #FA8072;" # RGB 값
                             "border-radius: 3px") # 경계선 둥글둥글한거 값 줄이면 직각
        # setStyleSheet() 메서드를 이용해서 글자색을 빨간색(red)으로,
        # 경계선을 실선(solid)으로, 경계선 두께를 2px로, 경계선 색을 #FA8072로,
        # 경계선의 모서리를 3px만큼 둥글게 설정합니다.
        lbl_green.setStyleSheet("color: green;"
                               "background-color: #7FFFD4") # 백그라운드 색
